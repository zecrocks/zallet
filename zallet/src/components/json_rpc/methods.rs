...
pub(crate) trait WalletRpc {
    ...
    ///
    /// # Arguments
    /// - `zcashaddress` (string, required): The Zcash transparent address to use for signing.
    /// - `message` (string, required): The message to sign.
    #[method(name = "signmessage")]
    async fn sign_message(&self, zcashaddress: &str, message: &str) -> sign_message::Response;
}
